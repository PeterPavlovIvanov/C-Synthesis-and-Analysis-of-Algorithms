...
void ShelvesView::SetColumnsShelvesListCtrl()
{
	...
	listCtrl.InsertColumn(1, _T("SHELF_NAME"), LVCFMT_RIGHT, COLUMN_WIDTH_BASIC);
	listCtrl.InsertColumn(2, _T("RACK_NAME"), LVCFMT_RIGHT, COLUMN_WIDTH_BASIC);
	listCtrl.InsertColumn(3, _T("ID"), LVCFMT_RIGHT, COLUMN_WIDTH_BASIC);
}
