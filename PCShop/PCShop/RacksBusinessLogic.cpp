...
BOOL RacksBusinessLogic::SelectAllByRackID(ShelvesArray & shelvesArray, int rackID)
{
	ShelvesTable shelfTable;

	BOOL hResult = shelfTable.SelectAllByRackID(shelvesArray, rackID);
